...
const ForgetPass = () => {
  ...
  const updatePassword = async (e)=>{
    ...
    try {
      ...
      const response = await axios.patch(`http://localhost:8000/user/updateUserPassword`,{
              ...
              <div className='mx-4 p-2 mt-2 '>
                ...
                <form className="p-5" onSubmit={updatePassword}>
                  ...
                  <div className="form-outline mb-4">
                    ...
                    />                
                    { error && !password ? <label className="form-label text-danger " style={{position:'absolute'}} > Field Is Required </label> :"" } 
                   ...
                   <div className="form-outline mb-4">
                    ...
                    />
                     { error && !confPassword ? <label className="form-label text-danger " style={{position:'absolute'}} > Field Is Required </label> :"" } 
                  </div>
